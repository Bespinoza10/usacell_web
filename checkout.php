						...
						<table>
							...
							<tbody>
								...
								<tr class="table-row2">
									...
									<td class="cart_product_total_value"><span class="product_price">$63.00</span></td>
								</tr>
								<tr class="table-row3">
									<td class="cart_empty_footer" colspan="3"></td>
									<td class="cart_final_total_title">Total</td>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="convert-cart">
						<p>You chose the payment method: <span>PayPal</span></p>
					</div>
				</div>
			</div>
		</div>
